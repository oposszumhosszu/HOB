package HOB;                                                                            //Include this class in the EvilMario game package
...
public class Player {
    ...
    ImageIcon playerFacingLeft = new     ImageIcon("D:/Programok/!Oposszum2/!HOB/PL_gifmaker.gif");        //Image for player while he is     turning left
    ImageIcon playerFacingRight = new     ImageIcon("D:/Programok/!Oposszum2/!HOB/PR_gifmaker.gif");//Image for player while he is turning right

        public Player() {
            player = playerFacingRight.getImage();                                               //Give the player the image
            x = 75;                                                                              //The original x position of the player
            y = 485;                                                                             //The original y position of the player
        ...
        public void keyPressed(KeyEvent e) {                                                     //Called from the board class, the argument is whatever key was pressed
            ...
            //
            if(key == KeyEvent.VK_UP) {                                                          //If the key sent was SPACE
                	jumpStrength = 24;
                    y = floorHeight;
                    y -= jumpStrength;
                    jumpStrength -= weight;
